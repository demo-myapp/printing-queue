...
<body>
        ...
        <div class="main-wrapper">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; Rizqi <?= date('Y'); ?> <div class="bullet"></div>
                </div>
    ...
    <script>
        function previewDoc() {
            ...
            const docLabel = document.querySelector('.custom-file-label');

            docLabel.textContent = doc.files[0].name;

            const fileDoc = new FileReader();
            fileDoc.readAsDataURL(doc.files[0]);

            fileDoc.onload = function(e) {
                docLabel.src = e.target.result;
            }
        }
    </script>
</body>
